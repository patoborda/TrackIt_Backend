...
namespace trackit.server.Data
{
    public class UserDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Filtro global para eliminaciones l�gicas
            modelBuilder.Entity<Requirement>().HasQueryFilter(r => !r.IsDeleted);

            // Configuraci�n de la relaci�n uno-a-uno User -> InternalUser
            ...
            // Configuraci�n de la relaci�n uno-a-uno User -> ExternalUser
            ...
            // Configuraci�n de la relaci�n uno-a-uno User -> AdminUser
            ...
            // Configuraci�n de la relaci�n muchos-a-muchos User -> Requirement
            ...
            // Configuraci�n de la relaci�n auto-referenciada RequirementRelation -> Requirement
            ...
            // Configuraci�n de la relaci�n Requirement -> RequirementType
            ...
            // Configuraci�n de la relaci�n Requirement -> Category
            modelBuilder.Entity<Requirement>()
                .HasOne(r => r.Category)
                .WithMany()
            ...
            // Configuraci�n de la relaci�n Requirement -> Priority
            modelBuilder.Entity<Requirement>()
                .HasOne(r => r.Priority)
                .WithMany()
            ...
            // Configuraci�n de la relaci�n muchos-a-muchos User -> Notification
